---
layout: single
title: Call for Papers <br> WASP @ IJCNLP-AACL 2025
permalink: /2025/call_for_papers
sidebar:
  nav: "sidebar2025"
---
...
***Shared Task: [Telescope Reference and Astronomy Categorization Shared task (TRACS)](shared_task)***

Instructions can be found [here](shared_task).

<!---
XX UPDATE w/ registration link for shared task
--->
...
- Deadline for TRACS shared task: 
- Notification of workshop paper acceptance: 
- Deadline for TRACS shared task system papers: 
- Camera-ready submission deadline (WASP+TRACS): 
